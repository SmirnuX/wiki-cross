...
void main() {
  ...
  test('Проверка замены слова [1]', () {
    ...
    String output = '_____________ район - упразднённая административно-территориальная единица и муниципальное образование на западе Московской области России.';
  ...
  test('Проверка удаления сносок', () {
    ...
    String output = 'Google ____ - база данных, созданная компанией Google в ноябре 2005 года.';
  ...
  test('Проверка форматирования статей с Википедии [0]', () {
    ...
    String output = 'Чарльз _______ - британский химик и предприниматель.';
  ...
  test('Проверка форматирования статей с Википедии [2]', () {
    ...
    String output = '___________ Штаты Америки, сокращённо США, или ___________ Штаты - государство';
