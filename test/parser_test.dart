...
import 'package:wiki_cross/wiki.dart';
...
void main() {
  test('Проверка удаления специальных символов', () {
    ...
    expect(CleanText(input, '', true), output);
  });
  ...
  test('Проверка замены слова', () {
    ...
    expect(CleanText(input, 'МИР', true), output);
  });
  ...
  test('Проверка замены слова [1]', () {
    ...
    expect(CleanText(input, 'ВОЛОКОЛАМСКИЙ', true), output);
  });
  ...
  test('Проверка удаления сносок', () {
    ...
    expect(CleanText(input, 'BASE', true), output);
  });
  ...
  test('Проверка форматирования статей с Википедии [0]', () {
    ...
    expect(CleanText(input, 'ТЕННАНТ', true), output);
  });
  ...
  test('Проверка форматирования статей с Википедии [1]', () {
    ...
    expect(CleanText(input, 'ХИМИК', true), output);
  });
  ...
  test('Проверка форматирования статей с Википедии [2]', () {
    ...
    expect(CleanText(input, 'СОЕДИНЁННЫЕ', true), output);
  });
  ...
  test('Проверка форматирования статей с Википедии [3]', () {
    ...
    expect(CleanText(input, 'Тьеррас-Альтас', true), output);
  });


  test('Проверка обрезания контента с точкой в районе заданного предела', () {
    String input = 'Привет, мир. Пока, мир.';
    String output = 'Привет, мир.';
    expect(TrimContent(input, 20), output);
  });

  test('Проверка удаления запятой в конце слова', () {
    String input = 'Николаев, А';
    String output = 'НИКОЛАЕВ';
    expect(CheckWord(input, 20), output);
  });

  test('Проверка форматирования статей с Википедии [3]', () {
    String input = 'Hunt the Wumpus - классическая текстовая компьютерная игра, написанная Грегори Йобом в 1972 год.';
    List<dynamic> output = [1, 'Hunt ___ Wumpus - классическая текстовая компьютерная игра, написанная Грегори Йобом в 1972 год.'];
    expect(CleanText(input, 'THE', true), output);
  });

  test('Проверка удаления слов из скобок', () {
    String input = '(телеканал)';
    String output = 'ТЕЛЕКАНАЛ';
    expect(CheckWord(input, 20), output);
  });
  ...
  test('Проверка обрезания контента при использовании инициалов', () {
    String input = 'Однако, благодаря Николаеву А.Б., этого удалось избежать. А чего этого?';
    String output = 'Однако, благодаря Николаеву А.Б., этого удалось избежать.';
    String result = TrimContent(input, 60);
